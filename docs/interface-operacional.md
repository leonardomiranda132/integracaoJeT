...
1. comparar o novo visual com a rotina real da operacao no dia a dia
2. conferir com a operacao os 161 `billCode` criados no lote real de 2026-06-08
3. ajustar nomenclaturas e ordem dos modulos depois do primeiro uso assistido
4. decidir se a tela `/steps` deve permitir parametros controlados, como janela
   de datas, indice do pedido e arquivo de saida
5. adicionar persistencia/auditoria dos cliques executados em `/steps`
6. adicionar autenticacao interna
7. adicionar comentarios/notas por pendencia
8. adicionar auditoria mais rica de acoes da interface
9. evoluir notificacoes e acompanhamento proativo
10. padronizar estados vazios, carregamento e erros no mesmo tema visual
